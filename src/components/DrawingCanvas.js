      ...
      <div className="tool-panel left">
        ...
        {showShapePanel && (
          <div className="shape-popup">
            <button className='optionBtn' onClick={() => { setTool('sharp-pain'); {
            ...
            <button className='optionBtn' onClick={() => { setTool('dull-ache'); {
              setShowShapePanel(prev => {
                const newState = !prev;
                if (!newState) setShowShapeEditor(false); // auto-close modal
                return newState;
            ...
            <button className='optionBtn' onClick={() => { setTool('tingling'); {
              setShowShapePanel(prev => {
                const newState = !prev;
                if (!newState) setShowShapeEditor(false); // auto-close modal
                return newState;
            ...
            <button className='optionBtn' onClick={() => { setTool('numbness'); {
              setShowShapePanel(prev => {
                const newState = !prev;
                if (!newState) setShowShapeEditor(false); // auto-close modal
                return newState;
